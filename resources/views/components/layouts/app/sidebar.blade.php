    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group class="grid">
                ...
                @endif
                <flux:navlist.item icon="layout-grid" :href="route('brands')" :current="request()->routeIs('brands')"
                    wire:navigate>{{ __('Brands') }}</flux:navlist.item>
                <flux:navlist.item icon="layout-grid" :href="route('categories')"
                    :current="request()->routeIs('categories')" wire:navigate>{{ __('Categories') }}</flux:navlist.item>
                <flux:navlist.item icon="layout-grid" :href="route('items')" :current="request()->routeIs('items')"
